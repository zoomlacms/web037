<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MailTemplist, App_Web_33pz3vfn" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script>
        $().ready(function () {
            $("#EGV tr>th:eq(0)").html("<input type=checkbox id='chk' />");
            $("#chk").click(function () {
                SelecteAllByName(this,"chkAll");
            });
        });
