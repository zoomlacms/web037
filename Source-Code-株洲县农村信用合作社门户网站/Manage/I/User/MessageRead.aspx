<%@ page language="C#" title="读取短消息" autoeventwireup="true" inherits="User.MessageRead, App_Web_wmnrvghs" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
