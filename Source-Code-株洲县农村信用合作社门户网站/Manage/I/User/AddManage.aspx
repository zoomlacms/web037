<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AddManage, App_Web_kw3nhfce" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-pane active" id="home">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="cb1"  onkeydown="return GetEnterCode('focus','cb2');" runat="server" />
                        允许多人同时使用此帐号登陆<br />
                        <asp:CheckBox ID="cb2"  onkeydown="return GetEnterCode('focus','cb3');" runat="server" />
                        允许管理员修改密码<br />
                ...
                <tr id="showmenu" runat="server">
                    <td class="title" colspan="2">
                        <asp:CheckBox Checked="true" ID="adduser" AutoPostBack="true"  onkeydown="return GetEnterCode('focus','tbQuestion');" runat="server"
