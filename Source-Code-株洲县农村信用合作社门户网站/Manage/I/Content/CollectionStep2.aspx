<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CollectionStep2, App_Web_dfmhp4qx" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                ...
                                <tbody id="Tabs0">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="r1" ControlToValidate="txtListStart" Display="Dynamic" ErrorMessage="正则不能为空" ForeColor="Red" ValidationGroup="NextG"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="r2" ControlToValidate="txtListEnd" Display="Dynamic" ErrorMessage="正则不能为空" ForeColor="Red" ValidationGroup="NextG"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
