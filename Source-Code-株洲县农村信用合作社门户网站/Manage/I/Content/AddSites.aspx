 <%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddSites, App_Web_dfmhp4qx" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Style="float:left; margin:7px;" runat="server" ControlToValidate="SiteKey_T"
                    ErrorMessage="站点密钥不能为空!" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td><asp:TextBox runat="server" ID="Nodes_T" CssClass="form-control" style="display:inline-block;"></asp:TextBox>
                <input type="button" value="选择" onclick="ShowDiv('node_div');" class="btn btn-primary" />
            </td>
        </tr>
            <tr>
