<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_caitttky" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="main_table" cellpadding="0" cellspacing="0">
    <tr>
        <td class="main_table_l">
            <div class="padding0">
            <a href="../I/Default.aspx">
	            <img src="<%= Call.Logo %>" alt="逐浪CMS_后台管理系统" title="重新加载后台" class="logoAdmin" />
            </a>
            </div>
        </td>
        <td>
    ...
    <div class="col-lg-3 col-md-2 col-sm-3 col-xs-12 padding0 m_top_rl">
		...
		<div class="dropdown pull-right ">
            <div class=" pull-right hidden-md hidden-sm  hidden-xs">
                <a href="/" target="_blank" title="返回首页"><img src="/App_Themes/AdminDefaultTheme/images/homepage.png"/></a>
                <a href="/user/" target="_target" title="ALT+U进入会员中心">
                ...
                <a href="javascript:void(0)" style="cursor: pointer;" title='Alt+Q锁定屏幕' onclick="showWindow('Lockin.aspx',900,460);">
                    <img alt="" src="/App_Themes/AdminDefaultTheme/images/lock_closed.jpg" style="vertical-align: middle;" /></a>
                <a style="color: white" href="<%= CustomerPageAction.customPath2 %>SignOut.aspx" title="退出"><%:lang.LF("退出") %></a>
...
<div id="left_ul_div">
	...
	<div id="menu2" class="m_left_ul">
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_5">
            ...
            <li id="menu2_5_6"><a href="javascript:;" data-url="Content/CollSite.aspx"><%:lang.LF("子站采集") %></a></li>
            <li id="menu2_5_7"><a href="javascript:;" data-url="Content/InfoLog.aspx"><%:lang.LF("子站采集日志") %></a></li>
	...
	<div id="menu7" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu7_1">
			...
			<li id="menu7_1_5"><a href="javascript:;" data-url="Config/DataSearch.aspx"><%:lang.LF("全库数据检索") %></a></li>
            <li id="menu7_1_6"><a href="javascript:;" data-url="Config/SQLManage.aspx"><%:lang.LF("计划任务") %></a></li>
			<li id="menu7_1_7"><a href="javascript:;" data-url="Config/CreateTable.aspx"><%:lang.LF("快速建表") %></a></li>
...
<script type="text/javascript" src="/JS/ICMS/Main.js?version=20140916a"></script>
