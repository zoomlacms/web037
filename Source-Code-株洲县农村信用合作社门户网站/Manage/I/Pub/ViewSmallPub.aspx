<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_ViewSmallPub, App_Web_ayruiiw2" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:HiddenField ID="HdnModelID" runat="server" />
   ...
   <table width="" border="0" cellpadding="0" class="table table-bordered table-hover table-striped" cellspacing="0">
    ...
    <asp:GridView ID="Egv" runat="server" AllowPaging="True"  AutoGenerateColumns="False"
        DataKeyNames="ID" PageSize="20" OnRowDataBound="Egv_RowDataBound" CssClass="table table-bordered table-hover table-striped" OnPageIndexChanging="Egv_PageIndexChanging"
