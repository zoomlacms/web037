<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_BackupRestore, App_Web_cj2e1e5w" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr class="tdbg">
            ...
            <td>
                ...
                <span style="float:left; margin-top:0.3em;"> 默认为网站根目录下的temp目录。</span>
            </td>
        </tr>
        <tr class="tdbg">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr class="tdbg">
            ...
            <td>
                ...
                <span style="float:left;margin:0.3em;">全站不含Temp目录的所有文件打包。</span>
            </td>
        </tr>
        <tr class="tdbg">
