<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_cj2e1e5w" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <%--  <asp:TextBox ID="TxtIndexTemplate" Width="200" runat="server" CssClass="form-control pull-left"></asp:TextBox>--%>
                            <asp:DropDownList runat="server" ID="IndexTemplate_DP" CssClass="form-control pull-left" DataTextField="rname" DataValueField="rname" EnableViewState="false" ></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList runat="server" ID="ShopTemplate_DP" CssClass="form-control pull-left" DataTextField="rname" DataValueField="rname" EnableViewState="false" ></asp:DropDownList>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                             <input type="checkbox" runat="server" id="RB_switch"  class="switchChk" onchange="DisApi()" />
                                    <div id="Api" runat="server" style="display:none;" >
                                        <asp:TextBox ID="TB_Api" runat="server" CssClass="form-control pull-left" Width="200"></asp:TextBox>&nbsp;
                                         <font class="rspan">提示：用于商城网店查询订单，<a href="http://www.kuaidi100.com/openapi/" target="_blank" style="color:#f00;text-decoration:underline;" >点此申请快递100集成密钥</a>。</font>
                                    </div>
                        </td>
                    </tr>
                    <tr>
