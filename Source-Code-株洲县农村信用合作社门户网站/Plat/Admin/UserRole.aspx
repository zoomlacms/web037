<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_UserRole, App_Web_ykvn12pb" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False"
        CssClass="table table-striped table-bordered table-hover" EmptyDataText="当前没有信息!!" OnRowCommand="EGV_RowCommand">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="角色名称">
                <ItemTemplate>
                    <a href="RoleAuth.aspx?ID=<%#Eval("ID") %>" target="_blank"> <%# Eval("RoleName")%></a>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="AddUserRole.aspx?ID=<%#Eval("ID") %>"><span class="glyphicon glyphicon-pencil"  style="color:#7D98A1;"></span></a>
