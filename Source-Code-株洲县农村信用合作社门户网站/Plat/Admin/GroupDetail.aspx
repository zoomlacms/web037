<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_GroupDetail, App_Web_wfumc33z" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="Head"><title>部门详情</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb" style="margin-bottom:10px;">
        ...
        <li class="active"><asp:Label runat="server" ID="GName_L"></asp:Label>
            <a href="javascript:;" style="margin-left:10px;color:red;" onclick="selCuser();">[添加成员]</a>
            <a href="javascript:;" style="margin-left:3px;color:red;" onclick="selRuser();">[添加管理员]</a>
        </li>
    </ol>
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab0" data-toggle="tab">成员信息</a></li>
            ...
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandName="Del2" CommandArgument='<%#Eval("UserID") %>' OnClientClick="return confirm('你确定要移除吗!');" ToolTip="移除">
                              <span class="glyphicon glyphicon-trash" style="color:#7D98A1;"></span></asp:LinkButton>
                            <a href="#" title="编辑"><span class="glyphicon glyphicon-pencil" style="color: #7D98A1;"></span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
