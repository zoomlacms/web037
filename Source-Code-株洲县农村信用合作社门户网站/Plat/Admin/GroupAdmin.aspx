<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_GroupAdmin, App_Web_ykvn12pb" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="GroupDetail.aspx?ID=<%#Eval("ID") %>" title="修改信息">修改</a>
                    ...
                    <div class="modal-body">
                      <table class="table table-bordered">
                           ...
                           <tr><td>管理员：</td><td>
                               ...
                               <asp:HiddenField runat="server" ID="ManageIDS_Hid" />  <asp:HiddenField runat="server" ID="HiddenField1" />
                                             </td></tr>
                           <tr><td>组成员：</td><td>
