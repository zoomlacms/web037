<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_AddUserRole, App_Web_wfumc33z" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tr>
            <td class="menu">备注：</td>
            <td><asp:TextBox CssClass="form-control" ID="RoleDesc_T" runat="server" style="width:400px;height:100px;"></asp:TextBox></td>
        </tr>
        <tr>
