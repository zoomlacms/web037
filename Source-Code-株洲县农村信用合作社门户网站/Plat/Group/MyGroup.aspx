<%@ page language="C#" autoeventwireup="true" inherits="Plat_Group_MyGroup, App_Web_gp41fucz" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                       ...
                       |<a href="javascript:;" onclick="return confirm('确定要退出该组吗!!');">退出</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <table class="table table-bordered">
                           ...
                           <tr><td style="line-height:200px;">管理员：</td><td>
                               <textarea id="ManageIDS_T" class="form-control" style="height:200px;width:300px;min-width:300px;"></textarea>
                               <input type="button" value="选择" onclick="selRuser();" class="btn btn-primary" style="margin-left:5px;position:relative;bottom:100px;" />
                               <asp:HiddenField runat="server" ID="ManageIDS_Hid" />
                                             </td></tr>
                           <tr><td style="line-height:200px;">组成员：</td><td>
                               <textarea id="MemberIDS_T" class="form-control" style="height:200px;width:300px;min-width:300px;"></textarea>
                               <input type="button" value="选择" onclick="selCuser();" class="btn btn-primary" style="margin-left:5px;position:relative;bottom:100px;"/>
