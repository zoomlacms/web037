<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_ViewDrafting, App_Web_qjswm1ux" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        <ol class="breadcrumb">
            ...
            <li>行政公文</li>
            <li><asp:Label runat="server" ID="title_lab" Text="公文起草"></asp:Label>
                <span title="打印公文"><a href="/Common/PrintPage.aspx?appID=<%=Request.QueryString["ID"] %>" target="_blank">
                <img class="startprint" onclick="doprint()" alt="" src="/Template/V3/style/images/print-btn.png" style="width:75px;height:22px;" /></a></span>
            </li>
            </ol>
