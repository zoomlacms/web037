<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_ReadOffice, App_Web_qjswm1ux" validaterequest="false" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb">
       ...
       <li><span>公文详情</span>
            <span title="打印公文" style="margin-left: 5px;">
                <a href="/Common/PrintPage.aspx?appID=<%=Request.QueryString["AppID"] %>" target="_blank">
                    <img class="startprint" onclick="doprint()" alt="" src="/Template/V3/style/images/print-btn.png" style="position: relative; width: 80px; height: 25px;" /></a></span></li>
    </ol>
