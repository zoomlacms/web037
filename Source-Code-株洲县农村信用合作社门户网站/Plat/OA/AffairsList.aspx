<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_AffairsList, App_Web_qjswm1ux" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  EnableTheming="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                  <a href="ReadAffair.aspx?AppID=<%#Eval("ID") %>">详情</a>|
