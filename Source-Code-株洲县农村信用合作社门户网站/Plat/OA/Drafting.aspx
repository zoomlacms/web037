<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Drafting, App_Web_qjswm1ux" validaterequest="false" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div style="padding-left: 10px; padding-right: 10px; min-width: 960px;">
            <table class="table table-bordered" style="margin-top:10px;">
                ...
                <tr>
                    ...
                    <td colspan="3">
                       <%-- <div id="OAkeyword" style="max-width: 300px;"></div><div class="clearfix"></div>--%>
                        <asp:TextBox ID="Keywords" runat="server" CssClass="form-control"></asp:TextBox>
                    </td>
                    <td class="text-right" style="width: 100px;">起草日期：</td>
                    <td>
                        <asp:TextBox ID="CreateTime" Width="300" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" CssClass="form-control"></asp:TextBox></td>
                ...
                <tr runat="server" id="upFileTR">
                    ...
                    <td colspan="7">
                        <table id="attachTB">
                            <tr><td>
                                    <input type="file" name="fileUP" class="fileUP" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
