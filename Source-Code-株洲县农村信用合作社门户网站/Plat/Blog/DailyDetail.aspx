<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_Declined, App_Web_mx1e5xbt" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div style="padding-left:1em; padding-top:10px;">         
           <table id="DetailTable">
                    ...
                    <tr>
                        ...
                        <td>
                           <span> <asp:TextBox runat="server" ID="Place" CssClass="form-control required date"></asp:TextBox></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <span class="glyphicon glyphicon-user"></span>
                            <a href="#">管理员</a><span>创建</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-user"></span>
                            <span>主负责人：</span>
                            <a href="#"><span class="glyphicon glyphicon-plus-sign" title="添加"></span></a>
                        </td>
                        <td>
                           <asp:Label runat="server" ID="LeaderIDS_L"></asp:Label>
                        </td>
                    </tr>
               <tr>
                   <td>
                   ...
                   <td>
                    ...
                    <tr>
                        <td>
                            <span class="glyphicon glyphicon-list-alt"></span><span>详情：</span>
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="Describe" CssClass="form-control required date" TextMode="MultiLine" style="max-width:100%;width:100%;height:60px;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:CheckBox runat="server" ID="IsOpen_Chk" /><span class="glyphicon glyphicon-lock"></span><span>公开日程</span>
                            </td>
                    </tr>
                    <tr>
