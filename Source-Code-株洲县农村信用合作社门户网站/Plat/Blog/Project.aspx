<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_Project, App_Web_mx1e5xbt" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <div id="head">
            <h4>我的项目</h4>
            <ul class="prolist_ul">
                <asp:Repeater runat="server" ID="ProList_Rep" OnItemCommand="ProList_Rep_ItemCommand">
                    <ItemTemplate>
                        <li class="pro_info_li" ondblclick="location='/Plat/Blog/?Pro=<%#Eval("ID") %>'" title="双击进入项目">
                          <div class="pro_info_op_div" style="text-align:right;padding-right:10px;">
                              <span class="glyphicon glyphicon-cog"  title="修改" onclick="EditPro(<%#Eval("ID") %>);"></span>
                              <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="Del" OnClientClick="return IsDel();">
                ...
                <li style="border: 1px #CCC dashed;" title="创建项目" data-toggle="modal" data-target="#add_Content">
                    <div class="box_head">
                        <div style="width: 80px; text-align: center; margin: auto;color: #ccc;">
                            <span class="glyphicon glyphicon-plus" style="font-size: 2em; "></span>
            ...
            <table >
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="line"><input type="text" id="LeaderIDS_T" class="form-control"/><input type="button" value="选择" onclick="selRuser();" class="btn btn-primary" style="margin-left:5px;" />
                          <asp:HiddenField runat="server" ID="LeaderIDS_Hid" /></td>
                </tr>
                 <tr>
                    <td class="line"><span class="important">*</span>项目成员:</td>
                    <td class="line"><input type="text" id="PartTakeIDS_T" class="form-control"/><input type="button" value="选择" onclick="selCuser();" class="btn btn-primary" style="margin-left:5px;"/>
                 ...
                 <tr>
                    ...
                    <td class="line"> <asp:TextBox class="form-control" ID="StartDate" runat="server" onclick="WdatePicker();" Style="width: 150px;"></asp:TextBox>
                        <asp:CheckBox runat="server" ID="Begin_Chk" Checked="true" />立即开始</td>
                </tr>
                 <tr>
                 ...
                 <tr>
                    ...
                    <td class="line">
                        <input type="radio" name="isOpen_rad" value="1" checked="checked" /><span>是</span>
                        <input type="radio" name="isOpen_rad" value="0" /><span>否</span></td></tr>
            </table>
        </div>
        <hr />
        <div>
