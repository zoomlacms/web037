<%@ page language="C#" autoeventwireup="true" inherits="Plat_DocContent, App_Web_mx1e5xbt" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb">
        ...
        <li><a title="信息中心" href="/Plat/Blog/">信息中心</a></li>
    ...
    <div class="col-lg-12">
        ...
        <thead>
            <tr><td colspan="7">
                <asp:Button runat="server" CssClass="btn btn-primary" Text="<" ID="PreMonth_Btn" OnClick="PreMonth_Btn_Click" ToolTip="上一月" />
                <strong style="font-size: 25px; position: relative; top: 4px;"><%:CurDate.ToString("yyyy年MM月") %> </strong>
                <asp:Button runat="server" CssClass="btn btn-primary" Text=">" ID="NextMonth_Btn" OnClick="NextMonth_Btn_Click" ToolTip="下一月" />
                </td></tr>
            <tr>
    ...
    <div class="modal fade" id="Add_Content">
        <div class="modal-dialog">
            <p style="margin-left: 1em;" class=" h4">
                新建日程 <a href="#"><span style="float: right; margin-right: 5em;"  data-dismiss="modal" onclick="getDate()" class="glyphicon glyphicon-remove"></span></a></p>
            ...
            <table id="Add_Table"> 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox class="form-controll required date " ID="txtBeginTime" runat="server" Text="" onclick="WdatePicker();" Width="30%"></asp:TextBox>
                        -
                        <asp:TextBox class="form-controll required date" ID="txtEndTime" runat="server" Text="" onclick="WdatePicker();" Width="30%"></asp:TextBox>
                    ...
                    <tr><td></td>
                        <td><input type="checkbox" runat="server" id="allDay" />全天事件<input type="checkbox" runat="server" id="repeat"/>重复</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="PartTakeIDS_T" class="form-control"  placeholder="选择用户名或姓名"/><input type="button" value="选择" onclick="selCuser();" class="btn btn-primary" style="margin-left:5px;"/>
                ...
                <tr>
                    <td></td>
                    <td><input type="checkbox" runat="server"  id="priva"/>私密日程</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <asp:Button ID="Add_Btn" runat="server" Text="提交" CssClass="btn btn-primary" OnClientClick="return VoteCheck();" OnClick="BtnAdd_Click"  ValidationGroup="Add" />
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <style type="text/css">
            ...
            #Add_Content {border: 1px solid #c1c8c5;font-family: 微软雅黑;background-color: white;width:600px;height:650px;margin:auto;overflow:hidden;border:3px solid #ddd;}
