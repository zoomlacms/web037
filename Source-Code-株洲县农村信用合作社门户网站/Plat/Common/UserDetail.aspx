<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_InfoDetail, App_Web_mhqnw4si" clientidmode="Static" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="content">
        <div id="head">
            <div id="head_img">
                <asp:Image runat="server" src="/Images/userface/noface.gif" class="imgface" ID="pre_img" Style="width: 100px; height: 100px;" />
            </div>
            <div id="head_name">
