<%@ page language="C#" autoeventwireup="true" inherits="Plat_Doc_CompDoc, App_Web_wssccn5o" masterpagefile="~/Plat/Main.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="margin-top: 10px; margin-bottom: 10px;">
        <span>文件路径：</span><span><a href="CompDoc.aspx" title="公司文库">公司文库</a>></span>
    ...
    <table class="table">
        <thead><tr><td style="width:60%;">名称</td><td style="width:20%;">大小</td><td style="width:20%;">创建时间</td></tr></thead>
        <tbody id="FListBody">
            ...
            <tr id="file_tr_<%#Eval("ID") %>" onmouseover="$(this).find('.hoverDiv').show();" onmouseout="$(this).find('.hoverDiv').hide();">
                <td>
                    <div style="position:relative;bottom:-10px;display:inline-block;">
                        <%#GroupPic.GetExtNameMini(Eval("ExName").ToString()) %>
                    </div>
                    <%#GetFileName() %>
                    <span class="hoverDiv" style="display:none;">
                        ...
                        <%#GetOP() %>
                        <a><span class='glyphicon glyphicon-refresh' title='重命名' onclick="ShowReName(<%#Eval("ID") %>);"></span></a>
                        <a><span class='glyphicon glyphicon-trash' title='删除' onclick="PostDel(<%#Eval("ID")+",'"+Eval("Name")+"'" %>);"></span></a>
                    </span>
                </td>
    ...
    <div style="display:none;">
       <a href="javascript:;" data-toggle="modal" data-target="#preview_div" id="PreView_A"></a>
    </div>
            ...
            <div class="modal-dialog" style="width:1024px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height:610px;overflow-y:scroll;">
                        <ul>
                            <li style="padding-bottom:5px;"><asp:TextBox runat="server" ID="ArtTitle_T" CssClass="form-control" placeholder="请输入文章标题" style="max-width:50%;width:400px;"></asp:TextBox></li>
                            <li><asp:TextBox runat="server" ID="Article_T" TextMode="MultiLine" Height="450px"></asp:TextBox></li>
                        </ul>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height:50px;">
                      <span>文件夹名：</span><asp:TextBox runat="server" ID="DirName_T" CssClass="form-control"></asp:TextBox>
                    </div>
