<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserInfo, App_Web_q5w2bxc1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                ...
                <tr class="tdbg" style="width: 100%">
                    <td style="width: 100%; margin-top: 5px; text-align: center" colspan="4">
                        ...
                        <input id="Button13" type="button" value="兑换银币" class="btn btn-primary" onclick="javascript: location.href = 'ExchangeSilverCoin.aspx'" />&nbsp;<br />
                        ...
                        <input id="Button4" type="button" value="有效期明细" class="btn btn-primary" onclick="javascript: location.href = 'PeriodHis.aspx'" />&nbsp;
