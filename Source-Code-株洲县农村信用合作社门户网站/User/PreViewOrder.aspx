<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_acisq4hr" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="DV_show">
        <div class="btn-group">
            ...
            <a href="PreViewOrder.aspx?menu=Orderinfo&type=5" class="btn btn-primary">作废订单</a>
            ...
            <asp:Panel ID="Orderlist" runat="server" Visible="false">
                <table class="table table-striped table-bordered">
                    ...
                    <asp:Repeater ID="Ordertable" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td style="text-align: center; white-space: nowrap; overflow: hidden"><a href="?menu=ViewOrderlist&id=<%#Eval("id") %>&ordid=<%#Eval("OrderNo")%>">
                                    <%#Eval("OrderNo")%></a> </td>
                    ...
                    <tr>
                        <td class="text-center" colspan="12">共
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <input id="Button14" onclick="window.open('PreViewOrder.aspx?menu=rebuy&id=<%=sid %>    &type=<%=ViewState["Type"]  %>    ');" type="button" value="重新购买" class="btn btn-primary" />
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width: 24.6%; text-align: center; white-space: nowrap; overflow: hidden">
                                        <a href='../shop.aspx?ItemID=<%#Eval("ItemID") %>' target='_blank'>
                                            <%#Gettypes(Eval("ProID","{0}"))%><%#DataBinder.Eval(Container, "DataItem.proname", "{0}")%>
                                        </a>
                                    </td>
                                    <td style="width: 13.6%; text-align: center">
