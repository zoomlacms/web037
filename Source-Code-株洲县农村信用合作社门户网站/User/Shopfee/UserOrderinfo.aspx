<%@ page language="C#" autoeventwireup="true" inherits="User_Shopfee_UserOrderinfo, App_Web_qiwy53kt" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>填写订单信息</title>
...
<ul style=" margin-bottom:20px">
	...
	<li style="width:150px;text-align:right;"><b><span style="color:#FF0000">*</span> 付款方式：</b></li><li></li>
...
<ul>
	...
	<li>&nbsp;<asp:TextBox ID="Email" runat="server"></asp:TextBox></li><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Email"
        ErrorMessage="收货人邮箱不能为空!" SetFocusOnError="True"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Email" ErrorMessage="邮件地址不规范" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$"></asp:RegularExpressionValidator></ul>
...
<div class="clear"></div>
    ...
    <ul>
      ...
      <li><asp:TextBox ID="Mobile" runat="server" MaxLength="11"></asp:TextBox>
