<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.AddContentpage, App_Web_mh0g4yb5" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td colspan="2" class="text-center">
                    ...
                    <input type="button" id="BtnBack" class="btn btn-primary" value="返回" onclick="javascript:location.href='MyContent.aspx?NodeID=<%=NodeID %>    '" />
