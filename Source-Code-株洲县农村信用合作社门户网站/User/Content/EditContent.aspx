<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.EditContentpage, App_Web_mh0g4yb5" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
	<ol class="breadcrumb">
        ...
        <li class="active">修改" + this.bnode.GetNodeXML(this.NodeID).NodeName + "</li>
    </ol>
