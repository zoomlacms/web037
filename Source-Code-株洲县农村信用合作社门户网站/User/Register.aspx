<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_t53uydxa" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body class="backs">
    <form id="form1" runat="server">
        ...
        <div class="container" style="padding-top: 20px; margin-top: 56px; margin-bottom: 100px;">
            <div id="reg_main">
...
<!--
    ...
    //-->
                ...
                <asp:Panel ID="PnlRegStep2" runat="server" Visible="false" Width="100%">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 border_right">
                        ...
                        <script type="text/javascript">
                            ...
                            }http://win01:86/App_Themes/UserThem/images/regl3.gif
                        ...
                        <div class="reg_sub"><!--注册用户--补全信息--注册成功(替换为图片形式)-->
                            <h1><span class="glyphicon glyphicon-user"></span>注册会员</h1>
                            <ul>
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">用户名：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                        ...
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0 ">
                                            ...
                                            <asp:RegularExpressionValidator ID="ValgTextMaxLength" ControlToValidate="TxtUserName" ValidationExpression="^[a-zA-Z0-9_\u4e00-\u9fa5\@\.]{4,40}$"
                                                SetFocusOnError="false" Display="Dynamic" runat="server" ForeColor="Red" />
                        ...
                        <asp:Literal ID="Literal2" runat="server"></asp:Literal>～<asp:Literal ID="Literal1" runat="server"></asp:Literal>个字符之间</span>
                                ...
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">密 码：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                ...
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">确认密码：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                            ...
                            <div runat="server" id="plat_div" class="reg_sub" visible="false"><!--能力中心-->
                            <h1><span class="glyphicon glyphicon-user"></span>能力中心</h1>
                            <ul>
                                <li runat="server" id="plat_invent_li" visible="false">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">企业名称：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                ...
                                <li runat="server" id="plat_create_li" visible="false">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">企业名称：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox runat="server" ID="CompName_T" CssClass="form-control" placeholder="企业名称" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">姓名：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TrueName_T" CssClass="form-control" runat="server" placeholder="姓名" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">职位：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="Post_T" CssClass="form-control" runat="server" placeholder="职位" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="Mobile_T" CssClass="form-control" runat="server" placeholder="手机号码" />
                                        </div>
                                    </div>
                                     <div class="clearfix"></div>
                                </li>
                            ...
                            <h4 class="text-left"><span class="glyphicon glyphicon-lock"></span>帐户安全设置</h4>
                            <ul>
                                <li>
                                    <div class="form-group">
                                ...
                                <li id="regEmail" runat="server">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">Email：</label>
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                            ...
                            <h4 style="text-align: left;"><span class="glyphicon glyphicon-plus-sign"></span>补充丰富资料</h4>
                            <ul>
                                <li>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-lg-2 col-md-2 col-xs-12 text-right padding0">用户类型：</label>
                                                ...
                                                <tr id="TRParentUserID" runat="server" visible="false">
                                                    <td colspan="2">
                                                        ...
                                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 text-left">
                                                            ...
                                                            <asp:CustomValidator runat="server" ID="PUR" ControlToValidate="TxtParentUserID" Display="None" ValidateEmptyText="true" ErrorMessage="推荐人不存在!" ForeColor="Red" SetFocusOnError="true" ClientValidationFunction="CheckParent"></asp:CustomValidator>
                                                            <asp:RequiredFieldValidator ID="ReqTxtParentUserID" runat="server" Display="None" ErrorMessage="推荐人不能为空" SetFocusOnError="false"
                                                                ControlToValidate="TxtParentUserID"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="trProvince" runat="server">
                                                    <td class="tdbgleft" colspan="2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 text-left">
                                                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0">
                                                                    <select runat="server" id="selprovince" onchange="javascript:area()" class="form-control">
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0">
                                                                    <select runat="server" id="selcity" onchange="area2();" class="form-control">
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0">
                                                                    <select runat="server" id="selcoutry" class="form-control">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-left">
                        <h3>已有账号？</h3>
                        <p><a href="/user/" class="btn btn-primary">立即登录</a></p>
                    </div>
                </asp:Panel>
            </div>
