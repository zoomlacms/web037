<%@ page language="C#" autoeventwireup="true" inherits="User_FindPwd, App_Web_t53uydxa" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="http://www.zoomla.cn" target="_blank">官网首页</a></li>
                        <li><a href="http://bbs.zoomla.cn/" target="_blank">技术社区</a></li>
                        <li><a href="http://www.zoomla.cn/pub/" target="_blank">下载产品</a></li>
                        <li><a href="http://help.zoomla.cn/" target="_blank">使用帮助</a></li>
                    </ul>
                </div>
            </div>
        </div>
