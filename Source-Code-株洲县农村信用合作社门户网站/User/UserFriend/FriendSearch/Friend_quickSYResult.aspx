<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserFriend_FriendSearch_Friend_quickSY, App_Web_rai3wrow" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <img src="<%#GetUserFace(Eval("UserFace").ToString()) %>" alt="" />
                        </a>
                        </td>
                        <td>
                            <a href="../../../ShowList.aspx?id=<%#Eval("UserID") %>">
                       ...
                       <td>
                           <a href="../../../ShowList.aspx?id=<%#Eval("UserID") %>">详细了解</a>
                       </td>
                        </tr>
                </ItemTemplate>
            </asp:Repeater>
