<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_ProductList, App_Web_sw1c1qgx" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="border: 1px solid #ddd; padding: 10px; margin-top: 10px;">
        <a href="ProductList.aspx?type=0">商品管理</a> |<a href="ProductList.aspx?menu=model&type=0"> 标准商品</a> | <a href="ProductAdd.aspx">添加商品</a>
