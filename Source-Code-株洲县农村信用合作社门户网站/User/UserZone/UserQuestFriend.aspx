<%@ page language="C#" autoeventwireup="true" inherits="User_Guild_UserQuestFriend, App_Web_hg0310kf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>找朋友</title>
    ...
    <div id="content">
        ...
        <table width="569" height="175" border="0" align="center" cellpadding="7" cellspacing="0"
            ...
            <tr>
                ...
                <td>
                    <span class="btmbian">
                    <asp:Button ID="btnSecher" runat="server" CssClass="i_bottom" Text="查找" onclick="btnSecher_Click" />
				</span>
                </td>
            </tr>
        </table>
        ...
        <br /><br />
        <table width="569" height="165" border="0" align="center" cellpadding="7" cellspacing="0"  class="biankuan">
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td width="406">
                    ...
                    <span class="btmbian">
                    <asp:Button ID="btnFirendUserName" runat="server" Text="查找" CssClass="i_bottom"  onclick="btnFirendUserName_Click"></asp:Button>
                    </span>
                </td>
            </tr>
            <tr>
        ...
        <asp:RangeValidator ID="RangeValidator1" runat="server" MaximumValue="99999"  MinimumValue="1" Type="Integer" ErrorMessage="请输入数字" ControlToValidate="userid">
                    ...
                    <span class="btmbian">&nbsp;<asp:Button ID="Button1" runat="server" Text="查找" CssClass="i_bottom" onclick="Button1_Click"></asp:Button>
                </td>
            </tr>
            <tr>
