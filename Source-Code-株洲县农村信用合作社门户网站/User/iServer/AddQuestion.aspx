<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="user_iServer_AddQuestion, App_Web_w5fyp003" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="iframeHtml">
                                                        <textarea runat="server" id="textarea1" class="ckeditor" name="content" rows="4" style="max-width: 715px; height: 300px;"
