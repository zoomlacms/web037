<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserOrderlist, App_Web_0iu3xfiv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>确认订单</title>
...
<body>
    ...
    <div id="main" class="rg_inout">
        ...
        <ul>
            <li style="width: 150px; text-align: right;"><b><span style="color:#FF0000">*</span> 收货人地址薄：</b></li>
            <li>
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="Receiver" runat="server" CssClass="input_out" Text="123131232"></asp:TextBox>
        ...
        <ul>
            ...
            <li>               
                ...
                <asp:TextBox ID="Jiedao" runat="server" Width="409px" CssClass="input_out" Text="123131232123131232"></asp:TextBox>
            </li>
            <li>
        ...
        <div class="cleardiv" style="margin-top: 10px">
        </div>
        <ul>
            <li style="width: 150px; text-align: right;"><b><span style="color:#FF0000">*</span> 收货人邮箱：</b></li>
            <li>
                <asp:TextBox ID="Email" runat="server" Text="468855@qq.com"></asp:TextBox></li><asp:RequiredFieldValidator
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="Phone" runat="server" CssClass="input_out" Text="0799-6422112"></asp:TextBox>格式:区号-号码
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="ZipCode" runat="server" CssClass="input_out" Text="331100"></asp:TextBox>
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="Mobile" runat="server" CssClass="input_out" MaxLength="11" Text="15387955566"></asp:TextBox>
